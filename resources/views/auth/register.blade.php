<x-guest>
    ...
    <form method="POST" action="{{ route('register') }}" novalidate class="space-y-4">
        ...
        <!-- Terms and Conditions Section (Without Checkbox) -->
        <div class="p-4 border-2 border-midnight bg-sand/40 space-y-3">
            <h3 class="font-bold text-midnight text-sm border-b border-midnight/20 pb-1">شروط وقواعد الأكاديمية</h3>
            <div class="text-xs font-medium text-midnight/80 space-y-2 leading-relaxed max-h-52 overflow-y-auto pr-1">
                <p>سادة أولياء الأمور الأعزاء، نحن ندرك المسؤولية الغالية التي وضعتموها في أعناقنا، وفي أكاديميتنا نحن نقدر ثقتكم ونعمل بكل جهد لنكون على قدر هذه الثقة، وحيث أنكم اخترتم أن تتركوا أبناءكم بين أيدينا، ومن منطلق حرصنا المشترك على مصلحة الطلاب، وتوفير بيئة تعليمية وتربوية آمنة ومنظمة، نرجو منكم الاطلاع على القواعد التالية والالتزام بها، لما فيه من خير للجميع.</p>
                
                <p class="font-bold text-midnight">يرجى مراعاة الآتي:</p>
                <ul class="list-disc list-inside space-y-1">
                    <li>الالتزام بقواعد المكان وهي في حال تواجد الطالب في الأكاديمية.</li>
                    <li>الحضور في الميعاد المحدد للكورس.</li>
                    <li>إبلاغ الإدارة مسبقاً في حال الغياب.</li>
                    <li>الغياب مرتين بدون عذر وبعدها لا يكون مسموح للطالب بالدخول ويتم منح مكانه لطالب آخر.</li>
                    <li>في حالة إلغاء الحصة من جهة الأكاديمية سوف يتم تعويض الحصة في يوم يتناسب مع الطالب، ولو لم نستطع توفيق ميعاد يتناسب مع الطالب لن نقوم بحساب الحصة.</li>
                    <li>في حالة الغياب من جهة الطالب وفي حالة طلب التعويض (محسوبة على الطالب)، نحاول تعويض الحصة ولكن سوف يقوم ولي الأمر بدفع رسوم إضافية.</li>
                    <li>إحضار الكتب والأدوات اللازمة للدراسة والمذاكرة.</li>
                    <li>الالتزام بتسليم الواجبات والمطلوب في الوقت المحدد.</li>
                    <li>يمنع التلفظ بألفاظ غير لائقة داخل الأكاديمية ويجب احترام المعلم والمدرب والزملاء. يتم التحدث مع الطالب بطريقة مهذبة في المرة الأولى، وفي حالة تكرار السلوك يتم التحدث مع ولي الأمر، وفي حالة المخالفة مجدداً لن نستطيع استقبال الطالب.</li>
                    <li>المحافظة على المكان ونظافته، ويتحمل الطالب تكلفة أي تلف ناتج عن التعمد.</li>
                </ul>

                <div class="pt-2 text-center font-bold text-midnight">
                    <p>مع خالص التحية،</p>
                    <p>إدارة الأكاديمية Shining Leaders</p>
                </div>
            </div>
        </div>
